...
const SidebarLink = ({
  ...
  return (
    <Link href={href}>
      <div
        className={`cursor-pointer flex items-center ${isCollapsed
            ? "justify-center py-4"
...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col ${isSidebarCollapsed ? "w-0 md:w-16" : "w-72 md:w-64"
    } bg-white dark:bg-black transition-all duration-300 overflow-hidden h-full shadow-md z-40`;
        ...
        */}
        ...
        <h1
          className={`${isSidebarCollapsed ? "hidden" : "block"
            } font-extrabold text-2xl text-gray-900 dark:text-white`}
        >
          PersianStock
        </h1>
