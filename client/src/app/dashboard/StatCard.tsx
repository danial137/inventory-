...
const StatCard = ({ title, primaryIcon, details, dateRange }: StatCardProps) => {
    ...
    return (
        <div className="md:row-span-1 xl:row-span-2 bg-white dark:bg-gray-800 col-span-1 shadow-md rounded-2xl flex flex-col justify-between text-gray-900 dark:text-white">
            {/* HEADER */}
            <div>
            ...
            <div className="flex mb-6 items-center justify-around gap-4 px-5">
                <div className="rounded-full p-5 bg-blue-50 dark:bg-gray-700 border-sky-300 dark:border-gray-600 border-1px">
                    {primaryIcon}
                </div>
